...
WorkspacePath          :=/home/ivan/UOC20242
ProjectPath            :=/home/ivan/UOC20242/UOCPlay
...
Objects0=$(IntermediateDirectory)/src_csv.c$(ObjectSuffix) $(IntermediateDirectory)/src_date.c$(ObjectSuffix) $(IntermediateDirectory)/src_person.c$(ObjectSuffix) $(IntermediateDirectory)/src_subscription.c$(ObjectSuffix) $(IntermediateDirectory)/src_film.c$(ObjectSuffix) $(IntermediateDirectory)/src_api.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/src_csv.c$(ObjectSuffix): src/csv.c 
	$(CC) $(SourceSwitch) "/home/ivan/UOC20242/UOCPlay/src/csv.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_csv.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_date.c$(ObjectSuffix): src/date.c 
	$(CC) $(SourceSwitch) "/home/ivan/UOC20242/UOCPlay/src/date.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_date.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_person.c$(ObjectSuffix): src/person.c 
	$(CC) $(SourceSwitch) "/home/ivan/UOC20242/UOCPlay/src/person.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_person.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_subscription.c$(ObjectSuffix): src/subscription.c 
	$(CC) $(SourceSwitch) "/home/ivan/UOC20242/UOCPlay/src/subscription.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_subscription.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_film.c$(ObjectSuffix): src/film.c 
	$(CC) $(SourceSwitch) "/home/ivan/UOC20242/UOCPlay/src/film.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_film.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_api.c$(ObjectSuffix): src/api.c 
	$(CC) $(SourceSwitch) "/home/ivan/UOC20242/UOCPlay/src/api.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_api.c$(ObjectSuffix) $(IncludePath)
