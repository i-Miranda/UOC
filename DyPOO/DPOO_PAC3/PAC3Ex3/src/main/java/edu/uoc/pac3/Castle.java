...
public class Castle {
   ...
   public final static String INVALID_CASTLE_TYPE = "[ERROR] Invalid castle " +
           "type";
    ...
    public Castle(String name, LocalDate constructionDate, double area,
            String symbolicArtifact, CastleType castleType) throws IllegalArgumentException {
        setName(name);
    ...
    public Castle(String name, LocalDate constructionDate, double area,
                  String symbolicArtifact, CastleType castleType, String keepLordName,
    ...
    private void setCastleType(CastleType castleType) throws IllegalArgumentException {
        if (castleType == null) {
